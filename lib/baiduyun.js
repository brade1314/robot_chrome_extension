;(function () {
  ...
  function slog(c1, c2, c3) {
    ...
    c2 = c2 ? c2 : '';
    c3 = c3 ? c3 : '';
    console.log('#' + ('00' + log_count++).slice(-2) + '-log:', c1, c2, c3);
  }
  ...
  function PanHelper() {
    ...
    function addButton() {
      ...
      var $dropdownbutton_span = $('<span class="menu" style="width:120px"></span>');
      ...
      var $apibutton_download_button = $('<a id="download-api" class="g-button-menu" href="javascript:void(0);">chrome直接下载</a>');
      ...
      var $github = $('<iframe src="https://ghbtns.com/github-btn.html?user=brade1314&repo=robot_chrome_extension/tree/baiduyun&type=star&count=true" frameborder="0" scrolling="0" style="height: 20px;max-width: 120px;padding: 0 5px;box-sizing: border-box;margin-top: 5px;"></iframe>');
      $dropdownbutton_span
